...
-- 11번
("**순대볶음 - 매콤달콤 순대볶음", 11, "맛있는 순대볶음 만들어보아요~~", "3인분", "30분 이내", "아무나"),
-- 12번
("**크림파스타 만들기 크림스파게티 만드는 법 생각보다 간단해요 :)", 12, "예전에 크림파스타가 생각보다 만들기 쉽다고 들은 적이 있어서 이번 기회에 한번 만들어보기로 했어요.진짜 간단해서 놀랬어요! 우리 같이 크림파스타 만들기 시작해보아요!", "1인분", "20분 이내", "초급"),
-- 13번
("**[간단요리]간장계란밥 만드는법,계란요리,자취생간단요리)", 13, "오늘은! 자취요리계의 대표주자! 간장계란밥!!!", "1인분", "5분 이내", "아무나"),
-- 14번
("**[연근조림] 아작 아작 달콤 짭쪼름한 연근 조림 만들기", 14, "연근 조림.. 너무나 좋아합니다. 밥도둑 너란 밥도둑.. 아작 아작 달콤 짭쪼름~ 연근조림 만들어봐요*대용량 주의*", "6인분 이상", "30분 이내", "아무나"),
-- 15번
("**백종원 어묵볶음 만드는법 간단하면서 맛있다", 15, "오늘은 간단한 밑반찬 레시피를 갖고 왔어요 :) 바로 제가 애정하는 백종원 선생님의 레시피로 어묵 볶음을 만들어 봤어요", "4인분", "30분 이내", "아무나"),
-- 16번
("**닭가슴살덮밥", 16, "이번에 만들어 본것은 닭가슴살 덮밥인데요. 좋아하는 야채를 넣어 만들어서 간단히 한끼로 먹기 넘 좋더라구요. 건강에 좋은 애호박과 양파도 듬뿍 넣어 만들어서 한끼 건강하게 먹을 수 있는 식단인것 같아요.", "2인분", "15분 이내", "아무나"),
-- 17번
("**카이막 만들기, 집에서 더 손쉽고 신선하게", 17, "요즈음 뜨는 튀르키예 디저트, 카이막! 만드는 방법은 어렵지 않지만 시간이 다소 소요돼 아직 카페에서도 쉽게 볼 수 없는 메뉴죠.", "2인분", "2시간 이상", "아무나"),
-- 18번
("**오버나이트오트밀 황금레시피", 18, "오트밀로 다이어트 밀프랩만들기 오버나이트오트밀로 단백질, 식이섬유, 비타민, 칼슘 챙겨보아요❤", "1인분", "5분 이내", "초급"),
-- 19번
("**초간단 머그컵 퐁당 오 쇼콜라*.*", 19, "단거를 너무 좋아해서 집에서 땡길때 마다 숟가락 하나로 만들어 먹었어요@,@ 노오븐 노계량 노버터에 집에 거의 있는 재료들로 뚝딱할 수 있음! 달달한 디저트 땡길때 추천이에", "1인분", "5분 이내", "초급"),
-- 20번
("**백종원 우유푸딩 만들기, 초간단 간식!", 20, "코로나 초반에 카페는 못가고 달달구리는 땡길 때가 있었는데요, 집에서 만들 수 있는 간단한 간식 우유푸딩을 만들어봤어요 백종원우유푸딩 레시피를 토대로 초코푸딩과 밀크티 푸딩도 만들어 봤어요", "2인분", "5분 이내", "아무나")
;

...
-- 21번
("**식당에서 먹던 맛과 비주얼 그대로, 폭탄 계란찜 만드는 법", 21, "지금부터 식당에서 먹던 맛과 비주얼 그대로 -", "2인분", "15분 이내", "초급", "localhost:8000/c807784ab41809f624a6a4a7466cd5bd1.jpeg"),
-- 22번
("**부추베이컨말이", 22, "간단한 술안주를 만들려고 냉장고를 들여보다가 급 만들게 되었는데요~ 대부분 팽이버섯을 베이컨에 많이 넣어 만들곤 하지만..전 향긋함과 영양을 더하기 위해 부추를 넣어봤어요. 느끼함도 잡아주고 완전 좋답니다^^", "2인분", "15분 이내", "초급", "localhost:8000/2e35349d4ca6d65611bab97efeec7a621.jpg"),
-- 23번
("**매운 팽이버섯 조림 간단 반찬", 23, "밥반찬으로도 술안주로도 좋은 매운 팽이버섯 초림♡♡", "1인분", "5분 이내", "초급", "localhost:8000/7f30d319399045be9491fa710fc260a71.jpg"),
-- 24번
("**닭가슴살캔으로 치즈 불닭 만들기 / 혼술안주", 24, "간편하게 닭가슴살캔으로 만드는 방법을 준비했는데요
생닭(가슴살/다리살)으로 만드셔도 좋습니다 !", "1인분", "30분 이내", "초급", "localhost:8000/a593822ae8e7e1b1268cccf473202a2e1.jpg"),
-- 25번
("**스팸 계란밥 전", 25, "아이들 반찬으로 간단한 술안주 만들기~", "2인분", "30분 이내", "초급", "localhost:8000/e406ac8ddcbdc05af9ca7f20aaa9dddb1.jpg"),
-- 26번
("**5분 맥주안주!중독성 강한 '황태채 버터구이'", 26, "만들기는 간단하지만 맛은 중독성 있는 초간단 맥주안주 황태채 버터구이를 소개합니다. 씹을수록 고소한 맛에 한번 먹으면 손을 놓을수 없답니다^^", "2인분", "5분 이내", "아무나", "localhost:8000/a0cf3bd26c5d5eba8f17bc8c46fb6e681.jpg"),
-- 27번
("**일식집st콘치즈 초간단 레시피!고소함 폭발!홈파티 맥주안주로 강추", 27, "일식집st콘치즈 초간단 레시피!고소함 폭발!홈파티 맥주안주로 강추", "2인분", "10분 이내", "초급", "localhost:8000/4e566cd552398823e631f347f2f7da031.png"),
-- 28번
("**항정살조림! 10분안에 끝!", 28, "정말! 간단하고 맛있는 절대 후회없는 항정살 조림입니다! 고기에 스며든 단짠의 소스와 쫄깃한 항정살의 식감! 아삭하고 청량감을 주는 생양파까지!", "2인분", "10분 이내", "초급", "localhost:8000/0911a7fb85fae8e9ec6d3c31d413a9081.jpg"),
-- 29번
("**닭 가슴살 양파 볶음", 29, "간단하게 들들 볶은 양파볶음 만들기~", "2인분", "15분 이내", "초급", "localhost:8000/7f72452227cf7928d6dc0d86ede6b5441.jpg"),
-- 30번
("**숲속의 버터 아보카도 맛있게 즐기기!'아보카도 베이컨구이'레시피", 30, "숲속의 버터라 불리는 아보카도는 여러가지 비타민과 미네랄이 들어 있어 건강한 식재료인데요! 생으로 먹으면 약간 맛이 없어서 베이컨과 조합을 시켰더니 반찬으로 참 좋더라구요^^", "2인분", "15분 이내", "초급", "localhost:8000/03a1dcaabcc02153ba23cb8a02a913d01.jpg")
;
